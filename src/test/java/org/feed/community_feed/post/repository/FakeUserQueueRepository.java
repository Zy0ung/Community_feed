...
import org.feed.community_feed.post.repository.post_queue.UserQueueRedisRepository;
...
@Repository
@Profile("test")
public class FakeUserQueueRepository implements UserQueueRedisRepository {
