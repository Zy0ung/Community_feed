...
public class QCommentEntity extends EntityPathBase<CommentEntity> {
    ...
    private static final long serialVersionUID = 462659506L;
    ...
    public final org.feed.community_feed.post.repository.entity.post.QPostEntity post;
    ...
    public QCommentEntity(Class<? extends CommentEntity> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new org.feed.community_feed.post.repository.entity.post.QPostEntity(forProperty("post"), inits.get("post")) : null;
    }
